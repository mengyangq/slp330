...
(function (w, d) {
  ...
  var GATES = {
    q01: "sec-p1b", q02: "sec-p1c sec-p1d", q03: "sec-p1e sec-p1f", q04: "sec-p2a", q05: "",
    q06: "sec-p2b", q07: "sec-p2c", q08: "sec-p2d", q09: "sec-p3a", q10: "sec-p3b",
    q11: "sec-p3c sec-p4a", q12: "sec-p4b", q13: "sec-p4c", q14: "sec-p4d",
    q15: "sec-p4e sec-cumulative"
  };
  /* table-of-contents subsection id -> the locked-content block that governs its visibility */
  var SUBLOCK = {
    "s-1-3": "sec-p1b", "s-1-4": "sec-p1c", "s-1-5": "sec-p1c", "s-1-6": "sec-p1d",
    "s-1-7": "sec-p1e", "s-1-8": "sec-p1f", "s-1-9": "sec-p2a", "s-1-10": "sec-p2a",
    "s-2-1": "sec-p2b", "s-2-2": "sec-p2b", "s-2-3": "sec-p2b", "s-2-4": "sec-p2c",
    "s-2-5": "sec-p2d", "s-2-6": "sec-p3a", "s-2-7": "sec-p3a", "s-2-8": "sec-p3a",
    "s-2-9": "sec-p3a", "s-3-1": "sec-p3b", "s-3-2": "sec-p3c", "s-3-3": "sec-p3c",
    "s-3-4": "sec-p3c", "s-3-5": "sec-p4a", "s-3-6": "sec-p4a", "s-3-7": "sec-p4a",
    "s-4-1": "sec-p4b", "s-4-2": "sec-p4b", "s-4-3": "sec-p4c", "s-4-4": "sec-p4d",
    "s-4-5": "sec-p4d", "s-4-6": "sec-p4d", "s-4-7": "sec-p4e", "s-4-8": "sec-p4e",
    "s-4-9": "sec-p4e", "sec-cumulative": "sec-cumulative"
  };
  var visitedParts = {};
  var reached = false;
  ...
  function unlock(ids) {
    String(ids).split(/\s+/).filter(Boolean).forEach(function (id) {
  ...
  function persist() {
    ...
    else { try { w.localStorage.setItem("slp330l4_preview", data); } catch (e) { } }
  }
  function restorePreview() { try { var s = w.localStorage.getItem("slp330l4_preview"); if (s) restore(s); } catch (e) { } }
